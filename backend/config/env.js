...
export const env = {
  ...
  corsOrigin: parseList(process.env.CORS_ORIGIN || process.env.FRONTEND_URL || 'http://localhost:5173', ['http://localhost:5173']),
  corsMethods: parseList(process.env.CORS_METHODS || 'GET,POST,PUT,DELETE,OPTIONS', ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS']),
